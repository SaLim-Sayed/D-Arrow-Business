...
interface ThreadPanelProps {
  ...
  onClose: () => void;
  /** Overlay sits inside a chat popup so it does not stack another drawer. */
...
export function ThreadPanel({
  ...
  if (variant === "overlay") {
    ...
    return (
      <div className="absolute inset-0 z-30 flex flex-col bg-content1">
        <div className="flex shrink-0 items-center justify-between border-b border-default-100/80 bg-content1/90 px-3 py-2.5">
          <p className="text-sm font-semibold">{t("thread.title")}</p>
          <Button
            size="sm"
            variant="light"
            isIconOnly
