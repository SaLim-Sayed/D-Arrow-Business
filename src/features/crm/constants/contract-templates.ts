...
export function defaultContractClauses(): ContractClause[] {
  return [
    ...
    clause("قيمة العقد وشروط الدفع", [
      "القيمة الإجمالية: تبلغ القيمة الإجمالية لهذا العقد مبلغ وقدره {{amountExclVat}} ر.س، غير شامل ضريبة القيمة المضافة ({{vatRate}}%).",
      "جدول الدفع: الدفعة تدفع بالكامل بقيمة {{amountInclVat}} ر.س شامل القيمة المضافة عند التوقيع.",
    ]),
    ...
    clause("التزامات العميل", [
      ...
      "العدد: يلتزم العميل بالعدد المذكور سابقاً وفي حال إضافة أي صورة إضافية يتم دفع قيمة {{extraImagePrice}} ر.س عن كل صورة وبحد أدنى لا يقل عن {{minExtraImages}} صور.",
    ]),
